...
const homepage = () => {
  return (
    <div className="bg-neutral-50">
      {/** row 1 */}
      <div className="relative pt-5 w-[1100px] h-[500px] mx-20 rounded-tl-[10px] rounded-bl-[10px] overflow-hidden">
      ...
      <div className="flex justify-center mt-5">
        <div className="relative w-[1100px] h-[500px] rounded-tl-[10px] rounded-bl-[10px] overflow-hidden">
          ...
          <div className="relative flex h-full">
            ...
            <div className="flex-1 flex items-center justify-center ">
              {/* Right side content */}
              <div className=" ml-20">
                <h2 className="w-[410.66px] h-10 text-neutral-900 text-4xl font-normal font-['Playfair Display']">
                  Slimming Tea
                </h2>
      ...
      {/** row 3 */}
      <div className="relative mt-8 w-[1100px] h-[500px] mx-20 rounded-tl-[10px] rounded-bl-[10px] overflow-hidden">
        <div className="absolute inset-0 bg-yellow-500 opacity-25"></div>
        <div className="relative flex h-full">
          <div className="flex-1 flex items-center justify-center">
            {/* Left side content */}
